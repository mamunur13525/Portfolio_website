...
const PageLoading = () => {
  ...
  return (
    <div
      className={pageLoad ? "page_loading_div open" : "page_loading_div close"}
    >
          ...
          <div className="progress">
            <div
              ...
              style={{
                width: "100%",
                background:
                  "linear-gradient(90deg, rgba(177,5,23,1) 6%, rgba(226,227,52,0.9332107843137255) 51%, rgba(3,200,184,1) 92%)",
              }}
            >
